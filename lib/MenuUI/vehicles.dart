...
class vehicles extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final vehiclesPosts = reversedPosts
        .where((post) => post.description == 'Vehicles'&& post.address==nowaddress)
        .toList();
    return WillPopScope(
        onWillPop: () async {
    ...
    child: Scaffold(
      ...
      body: ListView.builder(
        itemCount: vehiclesPosts.length,
        itemBuilder: (context, index) {
          final post = vehiclesPosts[index];
